...
public class TiltBallActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        targetOne = new Target(this);

        mainView.addView(targetOne);
//        mainView.addView(new Target(this));
//        mainView.addView(new Target(this));
//        mainView.addView(new Target(this));
//        mainView.addView(new Target(this));
//        mainView.addView(new Target(this));
            ...
            public void run()
            {
                ...
                RedrawHandler.post(new Runnable()
                {
                    public void run()
                    {
                        ...
                        targetOne.invalidate();
                    }
                });

                if (targetOne.getR() - 0.05f > 0.5f)
                {
                    targetOne.setR((targetOne.getR() - 0.05f));
                    mBallView.setR(mBallView.getR() + 0.05f);
                }
